...
import * as mooModule from "moo";
const moo = mooModule.default || mooModule;
...
var grammar = {
    ...
    {"name": "value", "symbols": [(lexer.has("color") ? {type: "color"} : color)], "postprocess": d => d[0].value},
    ...
    {"name": "value", "symbols": ["list_expr"], "postprocess": d => d[0]},
    {"name": "value", "symbols": ["object_expr"], "postprocess": d => d[0]},
    ...
    {"name": "list_expr", "symbols": [{"literal":"["}, "_", "list_items", "_", {"literal":"]"}], "postprocess": d => d[2]},
    {"name": "list_items$ebnf$1", "symbols": []},
    {"name": "list_items$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "list_item"]},
    {"name": "list_items$ebnf$1", "symbols": ["list_items$ebnf$1", "list_items$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "list_items", "symbols": ["list_item", "list_items$ebnf$1"], "postprocess": 
        d => [d[0]].concat(d[1].map(x => x[3]))
        },
    {"name": "list_item", "symbols": [(lexer.has("word") ? {type: "word"} : word)], "postprocess": d => d[0].value},
    {"name": "list_item", "symbols": [(lexer.has("number") ? {type: "number"} : number)], "postprocess": d => parseFloat(d[0].value)},
    {"name": "list_item", "symbols": [(lexer.has("math") ? {type: "math"} : math)], "postprocess": d => d[0].value},
    {"name": "object_expr", "symbols": [{"literal":"{"}, "_", "kv_pairs", "_", {"literal":"}"}], "postprocess": d => d[2]},
